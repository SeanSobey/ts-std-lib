...
export interface IChainable<T> {
	 ...
	 * @param {(value: T) => U} callbackfn The chain method calls the callbackfn function one time for each element in the Mappable.
	 * @returns {IChainable<U>} A new Chainable of the results.
	 */
